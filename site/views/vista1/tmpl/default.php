...
<div class="vista1" style="text-align:center; display: table; margin: 0px auto;">
        <h1><?php echo JText::_('COM_CONTIGOMAS_FIELD_PARAM1_CODIGO_CORRECTO_LABEL');?></h1>       
        <div class="adminform" style="text-align:center">
					 <p><?php echo JText::_('COM_CONTIGOMAS_FIELD_PARAM2_CODIGO_CORRECTO_LABEL'); ?></p>
...
?>
		<div class='vista_error' style="text-align:center; display: table; margin: 0px auto;">
			<h1><?php echo JText::_('COM_CONTIGOMAS_FIELD_PARAM1_CODIGO_ERRONEO_LABEL');?></h1>
			<h6><?php echo JText::_('COM_CONTIGOMAS_FIELD_PARAM2_CODIGO_ERRONEO_LABEL');?></h6>
